        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" name="start_time" class="form-control" id="start_time" 
                    value="<?= isset($activity['start_time']) ? date('Y-m-d\TH:i', strtotime($activity['start_time'])) : '' ?>" required>
            </div>
            <div class="mb-3">
                ...
                <input type="datetime-local" name="end_time" class="form-control" id="end_time" 
                    value="<?= isset($activity['end_time']) ? date('Y-m-d\TH:i', strtotime($activity['end_time'])) : '' ?>" required>
            </div>
            <div class="mb-3">
